...
import { FiDroplet, FiMapPin, FiActivity, FiSettings, FiX, FiUser } from "react-icons/fi";
    ...
    >
      ...
      >
        ...
        <nav className="space-y-3 text-sm">
          ...
          <button onClick={() => onNavigate && onNavigate("profile")} className="w-full text-left px-3 py-2 rounded-lg hover:bg-slate-800/70 flex items-center gap-2">
            <FiUser /> Profile
          </button>
