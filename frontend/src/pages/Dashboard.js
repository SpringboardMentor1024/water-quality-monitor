...
const Dashboard = ({ onLogout }) => {
  ...
  // Function to handle page navigation (used by Sidebar and now Navbar's Profile button)
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-50 flex">
      ...
      <div className="flex-1 flex flex-col">
        <Navbar onMenuClick={() => setMobileOpen(true)} onLogout={onLogout} onNavigateToProfile={handleNavigation} onNavigate={handleNavigation} />
